...
public class ApplicationSecurity extends KeycloakWebSecurityConfigurerAdapter {
    ...
    protected AuthenticationEntryPoint authenticationEntryPoint() {
        KeycloakAuthenticationEntryPoint a = new KeycloakAuthenticationEntryPoint();
        a.setLoginUri("login");
        return a;
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/sso/**").permitAll().antMatchers("/swagger-ui.html").permitAll().antMatchers("/v1/**").permitAll().anyRequest().permitAll().and().csrf().disable();
    }
